...
namespace Miluc.Server.Interfaces.Nomina
{
    ...
    {
       public Task<(List<EsquemaVacunacionReaderDto> Data, int CantidadRegistros)> GetEsquemasVacunacionAsync(string? filtro = null, int page = 1, int? cantidad = null, string? correo = null);
